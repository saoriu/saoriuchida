    ...
    <div className="App" >
      ...
      <div className='title'>
        <div className='contact'>
          <a href="https://linkedin.com/in/saoriuchida/" target="_blank" rel="noopener noreferrer" onClick={() => window.gtag('event', 'click', { 'event_category': 'link', 'event_label': 'LinkedIn Click' })}>
            <div className="logo-container">
              <img src={LinkedInLogo} alt="LinkedIn" className="linkedin-logo" />
            </div>
          </a>
          <a href="https://github.com/saoriu" target="_blank" rel="noopener noreferrer" onClick={() => window.gtag('event', 'click', { 'event_category': 'link', 'event_label': 'Git Click' })}>
            <div className="logo-container">
          ...
          <a href="mailto:saori.uchid@gmail.com" target="_blank" rel="noopener noreferrer" onClick={() => window.gtag('event', 'click', { 'event_category': 'link', 'event_label': 'Email Click' })}>
            <div className="logo-container">
        ...
        <button className={`ai-button ${isCollapsed ? 'collapsed' : 'expanded'}`} onClick={() => {
          ...
          window.gtag('event', 'click', { 'event_category': 'button', 'event_label': 'AI Button Click', 'value': !isCollapsed });
        }}>
          ...
          <p className='about-me'>
            ...
            <span
              ...
              onClick={() => {
                ...
                window.gtag('event', 'click', { 'event_category': 'span', 'event_label': 'React Span Click' });
              }}
...
<div className='zontent'>
        ...
        <div className='suki-container'>
          ...
          <div className='exp'>
            ...
            <img src={eqx} alt="equinox" className="logo" onClick={() => { handleOpenModal('eqx'); window.gtag('event', 'click', { 'event_category': 'logo', 'event_label': 'Eqx Logo Click' }); }} />            
            ...
            <img src={un} alt="un" className="un-logo" onClick={() => { handleOpenModal('un'); window.gtag('event', 'click', { 'event_category': 'logo', 'event_label': 'UN Logo Click' }); }} />           
            ...
            <img src={maxell} alt="maxell" className="logo" onClick={() => { handleOpenModal('maxell'); window.gtag('event', 'click', { 'event_category': 'logo', 'event_label': 'Maxell Logo Click' }); }} />
